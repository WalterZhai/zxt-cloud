layui.use(['jquery','element', 'layer'], function () {
    ...
    $('.user-collect').on('click', function () {
        layer.open({
            ...
            area : [ '500px', '80%' ],
            fix : false,
            content : 'topage?url=system/index/user-collect.html'
        });
    });
    ...
    $('.online-user').on('click', function () {
        layer.open({
            ...
            area : [ '700px', '520px' ],
            fix : false,
            content : 'topage?url=system/index/online-user.html'
        });
    });

    $('.system-about').on('click', function () {
        layer.open({
            type : 2,
            maxmin : true,
            skin: 'out-class',
            ...
            area : [ '80%', '95%' ],
            fix : false,
            content : 'topage?url=system/index/system-about.html'
        });
    });
