package com.zxt.zxtcloud.system.bo;
...
public class SimpleRoleBo {
    ...
    public SimpleRoleBo(Role role) {
        ...
        this.modifyId = role.getModifyId();
        this.isDelete = role.getIsDelete();
        this.uda1 = role.getUda1();
        this.uda2 = role.getUda2();
        this.uda3 = role.getUda3();
        this.uda4 = role.getUda4();
        this.uda5 = role.getUda5();
    }
