...
import com.zxt.zxtcloud.system.Impl.MenuServiceImpl;
import com.zxt.zxtcloud.system.bo.SimpleMenuBo;
...
public class MenuService implements MenuServiceImpl {
    ...
    public JSONArray ajaxUserLoadTreeChecked(String username) {
        ...
        //获得用户已收藏的菜单
        Set<Menu> collectList = user.getCollects();
    ...
    //递归建模
    public JSONObject recursiveModel(Menu menu,List<Menu> menuList,Set<Menu> collectList){
    ...
    public void saveMenuCollect(JSONArray data, String username) {
        ...
        Set<Menu> list = menuRepository.findMenusByIsDeleteAndIdIn(0,resultIds);
