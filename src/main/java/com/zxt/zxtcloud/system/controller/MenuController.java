...
public class MenuController {
    ...
    public JsonResult addMenu(HttpServletRequest request,String id,String name,String href,Integer type,String icon) {
        try{
            ...
            Menu menu = new Menu();
            menu.setCode(SysConstant.SYSTEM_MENU_CODE_PREFIX + StringUtils.padLeft(docuNumServiceImpl.next(SysConstant.MENU_SEQ).getCur().toString(),3,"0"));
            menu.setName(name);
