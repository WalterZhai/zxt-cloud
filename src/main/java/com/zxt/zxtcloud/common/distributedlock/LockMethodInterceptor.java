...
import com.zxt.zxtcloud.system.entity.DistributedLock;
import com.zxt.zxtcloud.system.repository.DistributedLockRepository;
...
public class LockMethodInterceptor {
    ...
    @Around("execution(public * *(..)) && @annotation(com.zxt.zxtcloud.common.distributedlock.CacheLock)")
